...
core.DOMImplementation.prototype.createDocument = function(namespaceURI, qualifiedName, doctype) {
...
core.Node.prototype.isSupported = function(feature, version) {
...
core.NamedNodeMap.prototype.getNamedItemNS = function(namespaceURI, localName) {
  if (this._nsStore[namespaceURI] && this._nsStore[namespaceURI][localName]) {
    return this._nsStore[namespaceURI][localName];
  }
  return null;
};
core.NamedNodeMap.prototype.setNamedItemNS = function(arg) {
  if (this._readonly) {
    throw new core.DOMException(core.NO_MODIFICATION_ALLOWED_ERR);
  }
...
core.NamedNodeMap.prototype.removeNamedItemNS = function(namespaceURI, localName) {
  if (this.readonly) {
    throw new core.DOMException(core.NO_MODIFICATION_ALLOWED_ERR);
  }
...
core.Element.prototype.getAttribute = function(name) {
  var attr = this.getAttributeNode(name);
  return attr && attr.value;
};
core.Element.prototype.getAttributeNode = function(name) {
  return this._attributes.$getNoNS(name);
};
core.Element.prototype.removeAttribute = function(name) {
  return this._attributes.$removeNoNS(name);
};
core.Element.prototype.getAttributeNS = function(namespaceURI, localName) {
  if (namespaceURI === "") {
    namespaceURI = null;
  }
...
core.Element.prototype.setAttributeNS = function(namespaceURI, qualifiedName, value) {
  if (namespaceURI === "") {
    namespaceURI = null;
  }
...
core.Element.prototype.removeAttributeNS = function(namespaceURI, localName) {
  if (namespaceURI === "") {
    namespaceURI = null;
  }
  this._attributes.$remove(namespaceURI, localName);
};
core.Element.prototype.getAttributeNodeNS = function(namespaceURI, localName) {
  if (namespaceURI === "") {
    namespaceURI = null;
  }
...
core.Element.prototype.setAttributeNodeNS = function(newAttr) {
  if (newAttr.ownerElement) {
    throw new core.DOMException(core.INUSE_ATTRIBUTE_ERR);
  }
  return this._attributes.$setNode(newAttr);
};
core.Element.prototype.getElementsByTagNameNS = core.memoizeQuery(function(namespaceURI, localName) {
  var nsPrefixCache = {};
...
core.Element.prototype.hasAttribute = function(name) {
  if (!this._attributes) {
    return false;
  }
  return !!this._attributes.$getNoNS(name);
};
core.Element.prototype.hasAttributeNS = function(namespaceURI, localName) {
  if (namespaceURI === "") {
    namespaceURI = null;
  }
...
core.Document.prototype.importNode = function(importedNode, deep) {
  ...
  function lastChance(el) {
    ...
    if (defaults) {
      defaultEl = defaults.getNamedItemNS(el._namespaceURI, el._localName);
      if (defaultEl) {
...
core.Document.prototype.createAttributeNS = function(namespaceURI, qualifiedName) {
  var attribute,
