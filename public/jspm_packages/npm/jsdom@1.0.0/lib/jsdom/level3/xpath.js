  ...
  (function() {
    ...
    XPathExpression.prototype = {evaluate: function evaluate(contextNode, type, result) {
        ...
        if (XPathResult.NUMBER_TYPE === type)
          ...
          throw new core.DOMException(core.NOT_SUPPORTED_ERR, 'You must provide an XPath result type (0=any).');
    ...
    var proto = {
      ...
      iterateNext: function iterateNext() {
        ...
        if (this.invalidIteratorState)
          throw new core.DOMException(core.INVALID_STATE_ERR, 'The document has been mutated since the result was returned');
